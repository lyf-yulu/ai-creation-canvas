...
export default function CanvasProjectPage() {
    ...
    useEffect(() => { setModelId(availableModels[0]?.model_id || ""); setParams({}); }, [operation, models]);
