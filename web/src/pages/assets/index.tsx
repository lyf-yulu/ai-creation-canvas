            ...
            <main className="min-h-0 flex-1 overflow-y-auto bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] px-6 py-8 [background-size:16px_16px] dark:bg-[radial-gradient(rgba(245,245,244,.14)_1px,transparent_1px)]">
                <div className="pb-8">
                    <div className="mx-auto max-w-5xl text-center">
                        <h1 className="text-4xl font-semibold tracking-tight text-foreground">我的资产</h1>
                    ...
                    <div className="rounded-xl border border-border bg-card p-4 dark:border-border dark:bg-card">
                        ...
                        <div className="mt-3 overflow-hidden rounded-lg border border-border bg-background dark:border-border">
                            {coverUrl || imageDraft?.dataUrl ? (
                                ...
                                <div className="flex aspect-[4/3] items-center justify-center bg-muted p-5 text-center text-sm text-muted-foreground dark:bg-muted">{content || "暂无封面"}</div>
                            )}
                            <div className="p-4">
            ...
            cover={
                <button type="button" className="block w-full text-left" onClick={onOpen}>
                    {cover ? (
                        ...
                        <div className="flex aspect-[4/3] items-center justify-center bg-muted p-5 text-center text-sm leading-6 text-muted-foreground dark:bg-muted dark:text-muted-foreground">{asset.kind === "text" ? asset.data.content : "暂无封面"}</div>
                    )}
                </button>
            }
        >
            ...
            {asset ? (
                <div className="space-y-5">
                    {cover ? (
                        ...
                        <div className="rounded-lg border border-border bg-card p-5 text-sm leading-6 text-muted-foreground dark:border-border dark:bg-muted dark:text-muted-foreground">{asset.kind === "text" ? asset.data.content : "暂无封面"}</div>
                    )}
                    <div>
