...
export type ModelSpec = { model_id: string; service_id: string; display_name: string; operations: ModelOperation[]; input_media: ("text" | "image")[]; parameter_schema: Record<string, unknown>; requires_asset_kind?: "portrait" };
