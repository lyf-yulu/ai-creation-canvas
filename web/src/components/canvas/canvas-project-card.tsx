...
export function CanvasProjectCard({ project }: { project: CanvasProject }) {
    ...
    return (
        <article className="group flex min-h-44 cursor-pointer flex-col justify-between rounded-2xl bg-[var(--c-panel)] p-5 transition hover:bg-[var(--c-panel-hover)] dark:bg-white/5 dark:hover:bg-white/10" onClick={() => !editing && open()}>
            <div className="flex items-start gap-3">
                <input
                    ...
                    className="mt-1 size-4 accent-foreground dark:accent-foreground"
                ...
                {editing ? (
                    ...
                    >
                        ...
                        <p className="mt-3 text-sm leading-6 text-muted-foreground dark:text-muted-foreground">
